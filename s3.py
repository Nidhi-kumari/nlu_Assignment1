...
train_b,test=train_test_split(corpus_b, test_size=0.2,shuffle=False)
train_bg= train_b + corpus_g
...
train,validation=train_test_split(list(cleaned_train), test_size=0.2,shuffle=False)
